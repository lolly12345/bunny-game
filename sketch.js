...
function setup() {
  ...
  pushbutton = createImg('balloon.png');
  pushbutton.position(100, 250);
  pushbutton.size(100, 100);
  pushbutton.mouseClicked(blow);

  mutebutton = createImg('mute.png');
  mutebutton.position(400, 30);
  mutebutton.size(60, 60);
  mutebutton.mouseClicked(mute);



  rope = new Rope(5, {x:260, y:20});
  rope2 = new Rope(10, { x: 40, y: 30 });
